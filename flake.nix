{
  ...
  outputs = { self, nixpkgs, flake-utils, disko }:
    let
      version = "host-service-test.20260614T153357Z-g0cb4790f95b8-remote-dev-bin-test-0cb4790f95b8-1781450681";
      ...
      hostRuntimePackages = pkgs: remoteDevPackage: hostctrlPackage: runtimePackage: [
        pkgs.bash
        pkgs.coreutils
        pkgs.curl
        pkgs.fzf
      ...
      mkHostRuntimePackage = pkgs: remoteDevPackage: hostctrlPackage: runtimePackage:
        pkgs.buildEnv {
          name = "remote-dev-host-runtime";
          paths = hostRuntimePackages pkgs remoteDevPackage hostctrlPackage runtimePackage;
    ...
    in
    {
      ...
      lib.hostRuntimeSpecs = hostRuntimeSpecs;
      lib.hostRuntimeSpec = hostRuntimeSpecs.x86_64 or hostRuntimeSpecs.aarch64;
      ...
      nixosModules.remote-dev-host = { lib, pkgs, ... }:
        let
          ...
          hostctrlPackage = self.packages.${system}.remote-dev-hostctrl or
            (throw "remote-dev-hostctrl artifact is not published for ${system} in this remote-dev-bin ref");
        ...
        in
        {
          ...
          environment.systemPackages = hostRuntimePackages pkgs remoteDevPackage hostctrlPackage runtimePackage;
  ...
  remote-dev-hostctrl = mkLocalBinaryPackage
    ...
    "remote-dev-hostctrl"
    "remote-dev-hostctrl"
    ./artifacts/remote-dev-hostctrl-aarch64-linux.tar.gz;
